...
class _ApiService implements ApiService {
  ...
  @override
  Future<CategoryResponseBody> getAllProducts() async {
    ...
    final _value = CategoryResponseBody.fromJson(_result.data!);
    return _value;
  }
  ...
  @override
  Future<CategoryResponseBody> serachProduct(String categoryName) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>>(
      ...
      extra: _extra,
            ...
            .compose(
              _dio.options,
              'products/search?q=${categoryName}',
              queryParameters: queryParameters,
              data: _data,
            )
            .copyWith(
